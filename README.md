Since I can't share the code from the assignments from the Computer Networks course I took during Fall 2021 (UArizona), I have shared a description of my course projects. We built a software router that ran over the network topology provided by the [Virtual Network Lab](https://github.com/gkorpal/VNL) hosted on a Ubuntu 14.04 server.
